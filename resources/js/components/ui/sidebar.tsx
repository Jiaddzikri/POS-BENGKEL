...
function SidebarHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      data-sidebar="header"
      className={cn("flex flex-col gap-2 p-2 border-b-1", className)}
      {...props}
    />
  )
}
...
function SidebarFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      data-sidebar="footer"
      className={cn("flex flex-col gap-2 p-2 border-t-1", className)}
      {...props}
    />
  )
}
...
function SidebarMenuButton({
  ...
  // Return button without tooltip wrapper when expanded or on mobile
  return button
}
